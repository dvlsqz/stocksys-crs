<div class="row">
    <div class="col-md-12">
        ...
        <div class="input-group">           
            ...
            <select name="id_ubicacion" id="id_ubicacion" style="width: 92%" >
    ...
    <div class="col-md-12 mtop16">
        <label for="name"> <strong> Hora de Salida: </strong></label>
        <div class="input-group">
            <span class="input-group-text" id="basic-addon1"><i class="fas fa-keyboard"></i></span>
            {!! Form::time('field_name', \Carbon\Carbon::parse($ruta->hora_salida)->format('h:i:s'), ['class'=>'form-control']) !!}
        </div>
    </div>
